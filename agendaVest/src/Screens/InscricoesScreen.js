...
export default function InscricoesScreen() {
    ...
    function formatarData(data) {
        ...
        return `${String(dataFormatada.dia).padStart(2, '0')}/${String(
            dataFormatada.mes + 1
        ).padStart(2, '0')}/${dataFormatada.ano}`;
    }
    ...
    function gerarDiasCalendario() {
        ...
        for (let i = primeiroDia - 1; i >= 0; i--) {
            const quantidadeDiasAnterior = new Date(
                anoAtual,
                mesAtual,
                0
            ).getDate();
            ...
            <View style={styles.central}>
                <View style={styles.areaVisitante}>
                    ...
                    <Text style={styles.mensagemVisitante}>
                        Entre na sua conta para acessar sua agenda e acompanhar seus vestibulares.
                    </Text>
                ...
                <View style={styles.calendario}>
                    ...
                    <View style={styles.grade}>
                        {diasCalendario.map(item => {
                            ...
                            const possuiVestibular =
                                !item.outroMes &&
                                possuiVestibularNoDia(item.dia);
                ...
                <View style={styles.tituloDetalhes}>
                    ...
                    <View style={styles.contador}>
                        <Text style={styles.contadorTexto}>
                            {vestibularesHoje.length}
                        </Text>
                    </View>

                    <Text style={styles.textoVestibulares}>
                        {vestibularesHoje.length === 1
                            ? 'Vestibular'
                            : 'Vestibulares'}
                    </Text>
                </View>
